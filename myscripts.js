onload = function() {
  var DEBUG = false;
  var fade = false;
  const body_con = document.getElementById("body_container");
...
$(document).ready(function() {
  $("#strike_btn").on("click", function() {
    ...
    if ($(".samsung_logo").attr("src") === "./Logo_img/samsung_lions_2.png") {
      ...
      $(".hanhwa_logo").attr("src") === "./Logo_img/hanhwa_eagles_2.png"
    ) {
      $(".he_strike").toggle();
    } else if (
      $(".doosan_logo").attr("src") === "./Logo_img/doosan_bears_2.png"
    ) {
      $(".db_strike").toggle();
    } else if ($(".nc_logo").attr("src") === "./Logo_img/nc_dinos_2.png") {
      $(".nd_strike").toggle();
    } else if (
      $(".kiwoom_logo").attr("src") === "./Logo_img/kiwoom_heroes_2.png"
    ) {
      $(".kh_strike").toggle();
      ...
      $(".lotte_logo").attr("src") === "./Logo_img/lotte_giants_2.png"
    ) {
      $(".lg_strike").toggle();
